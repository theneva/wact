...
#### Vitnemålstekst
Overgangen til MVC-baserte front-end-rammeverk som AngularJS er å regne som ett av de aller største paradigmeskiftene i webutviklings historie. Emnet har gitt en innføring i god praksis og ulike verktøy (MongoDB, Express, AngularJS, og Node.js) til bruk under utvikling av webapplikasjoner og Application Programming Interfaces (API-er) innenfor dette nye paradigmet.
